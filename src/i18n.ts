    ...
    terminalSnippet: `$ mainline context --current --json
{
  ...
  "suggested_next_step": "use the Postgres advisory-lock path"
    ...
    selfHub: {
      eyebrow: "Self-dogfood",
      heading: "Mainline publishes its own live intent Hub.",
      text: "This is the Mainline Hub generated by the Mainline project itself, showing real intent records from day-to-day development. After your project adopts Mainline, it can generate the same kind of Hub to review historical decisions, risks, and work in progress.",
      cta: "Open the live Hub",
      pagesCta: "Open GitHub Pages snapshot",
      aria: "Live Mainline Hub statistics",
    ...
    terminalSnippet: `$ mainline context --current --json
{
  ...
  "suggested_next_step": "走 Postgres advisory-lock 路线"
    ...
    selfHub: {
      eyebrow: "自举证明",
      heading: "Mainline 会把自己的 intent Hub 发布出来。",
      text: "这是 Mainline 项目自己生成的 Mainline Hub，展示真实开发过程中留下的 intent 记录。你的项目接入 Mainline 后，也会生成同样的 Hub，用来查看历史决策、风险和正在进行的工作。",
      cta: "打开实时 Hub",
      pagesCta: "打开 GitHub Pages 快照",
      aria: "Mainline 实时 Hub 统计",
      live: "静态实时快照",
      updated: "更新时间",
    ...
    terminalSnippet: `$ mainline context --current --json
{
  ...
  "suggested_next_step": "usar el camino con Postgres advisory locks"
    ...
    selfHub: {
      eyebrow: "Self-dogfood",
      heading: "Mainline publica su propio Hub de intent.",
      text: "Este es el Mainline Hub generado por el propio proyecto Mainline, con registros de intent reales del desarrollo diario. Cuando tu proyecto adopte Mainline, podrá generar un Hub similar para revisar decisiones históricas, riesgos y trabajo en curso.",
      cta: "Abrir el Hub live",
      pagesCta: "Abrir snapshot en GitHub Pages",
      aria: "Estadísticas del Hub live de Mainline",
      live: "Snapshot estático live",
      updated: "Actualizado",
